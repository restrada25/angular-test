...
module.exports = "<!--The content below is only a placeholder and can be replaced.-->\n<div style=\"text-align:center\">\n  <router-outlet></router-outlet>\n</div>\n<footer class=\"page-footer font-small teal pt-4\">\n  <div class=\"footer-copyright text-center py-3\"> Ruben Estrada:\n    <a href=\"https://estrada-ruben.com\"> estrada-ruben.com</a>\n  </div>\n</footer>\n"
...
/* harmony import */ var _git_search_users_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./git-search-users.service */ "./src/app/git-search-users.service.ts");
/* harmony import */ var _git_search_git_search_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./git-search/git-search.component */ "./src/app/git-search/git-search.component.ts");
...
var appRoutes = [
    ...
    {
        path: 'search/:query',
        component: _git_search_git_search_component__WEBPACK_IMPORTED_MODULE_7__["GitSearchComponent"],
        data: {
            title: 'Git Search'
        }
    },
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _git_search_git_search_component__WEBPACK_IMPORTED_MODULE_7__["GitSearchComponent"],
            ...
            providers: [_git_search_service__WEBPACK_IMPORTED_MODULE_5__["GitSearchService"], _git_search_users_service__WEBPACK_IMPORTED_MODULE_6__["GitSearchUsersService"]],
...
/***/ "./src/app/git-search-users.service.ts":
/*!*********************************************!*\
  !*** ./src/app/git-search-users.service.ts ***!
  \*********************************************/
/*! exports provided: GitSearchUsersService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GitSearchUsersService", function() { return GitSearchUsersService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var GitSearchUsersService = /** @class */ (function () {
    function GitSearchUsersService(http) {
        var _this = this;
        this.http = http;
        this.cachedValues = [];
        this.gitSearchUsers = function (query) {
            var promise = new Promise(function (resolve, reject) {
                if (_this.cachedValues[query]) {
                    resolve(_this.cachedValues[query]);
                }
                else {
                    _this.http.get('https://api.github.com/search/users?q=' + query).toPromise()
    ...
    GitSearchUsersService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])({
            providedIn: 'root'
        }),
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]])
    ], GitSearchUsersService);
    return GitSearchUsersService;
}());
...
var GitSearchService = /** @class */ (function () {
    function GitSearchService(http) {
        ...
        this.http = http;
        this.cachedValues = [];
        this.gitSearch = function (query, pageNumber) {
            var promise = new Promise(function (resolve, reject) {
                if (_this.cachedValues[query]) {
                    resolve(_this.cachedValues[query]);
                }
                else {
                    _this.http.get('https://api.github.com/search/repositories?page=' + pageNumber + '&q=' + query).toPromise()
                        .then(function (response) {
                        resolve(response);
                    }, function (error) {
                        reject(error);
...
var GitSearchComponent = /** @class */ (function () {
    function GitSearchComponent(gitSearchService, route, router) {
        var _this = this;
        this.gitSearchService = gitSearchService;
        this.route = route;
        this.router = router;
        this.gitSearch = function () {
            _this.gitSearchService.gitSearch(_this.searchQuery, _this.pageNumber).then(function (response) {
        ...
        this.sendQuery = function () {
            ...
            _this.router.navigate(['/search/' + _this.searchQuery + '/' + _this.pageNumber]);
        };
        // newSearch = () => {
        //   this.pageNumber = 1;
        //   this.sendQuery();
    ...
    GitSearchComponent.prototype.ngOnInit = function () {
        ...
        this.route.paramMap.subscribe(function (params) {
            ...
            _this.pageNumber = parseInt(params.get('pageNumber'), 10);
            if (isNaN(_this.pageNumber)) {
                _this.pageNumber = 1;
            }
            _this.gitSearch();
        });
    ...
    GitSearchComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_git_search_service__WEBPACK_IMPORTED_MODULE_1__["GitSearchService"],
...
module.exports = "<nav class=\"navbar navbar-expand-lg navbar-light default-color lighten-4\">\n  <a class=\"navbar-brand\" routerLink='/' routerLinkActive='active'>Github Search</a>\n  <div class=\"collapse navbar-collapse\" id=\"basicExampleNav\"></div>\n  <ul class=\"navbar-nav mr-auto\">\n    <li class=\"nav-item\">\n        <a class=\"nav-link\" routerLink='/' routerLinkActive='active'>Home</a>\n    </li>\n    <li class=\"nav-item\">\n        <a class=\"nav-link\" routerLink='/search' routerLinkActive='active'>Search</a>\n    </li>\n  </ul>\n</nav>\n<h1 class=\"notFoundPage\">\n  404: Oops! That page doesn't exist. Please select a link below.\n</h1>\n"
...
module.exports = __webpack_require__(/*! /Users/restrad/Practice/Angular/angular-test/src/main.ts */"./src/main.ts");
